...
import com.huenei.utils.StorageUtils;
...
public class CleansingApplication {
	...
	public PubSubInboundChannelAdapter messageChannelAdapter(
		...
		PubSubInboundChannelAdapter adapter = new PubSubInboundChannelAdapter(pubSubTemplate, "subcs");
	...
	public MessageHandler messageSender(PubSubTemplate pubsubTemplate) {
		return new PubSubMessageHandler(pubsubTemplate, "developer");
	}
